...
public class RabbitMQConfig {
    ...
    // Shipping Exchange and Queue
    @Bean
    public DirectExchange shippingExchange() {
        return new DirectExchange("shipping.exchange");
    }
    
    @Bean
    public Queue shippingCreatedQueue() {
        return new Queue("shipping.created.queue", true);
    }
    
    @Bean
    public Binding shippingCreatedBinding(Queue shippingCreatedQueue, DirectExchange shippingExchange) {
